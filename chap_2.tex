...
West & Vaudreuil, Haut SL, Beauharnois \\
Centre & Jardins, Haut Richelieu, Rouville, Roussillon \\
North & \begin{tabular}[c]{@{}l@{}}Longueuil, Marguerite d'Youville, Vallée du richelieu, \\ Pierre de Saurel, Les Maskoutains\end{tabular} \\
East & Brome-Missisquoi, Haute Yamaska, Acton \\
Transversale tables (x2) & Toute la Montérégie \\ \hline
\end{tabular}
\end{table}
